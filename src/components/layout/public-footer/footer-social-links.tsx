...
interface SocialLink {
  /**
   * Nome da rede social para acessibilidade.
   */
  name: string;
  /**
...
const socialLinks: SocialLink[] = [
  ...
  { name: "Twitter", href: "https://twitter.com/papelito", icon: TwitterIcon },
  { name: "Facebook", href: "https://facebook.com/papelito", icon: FacebookIcon },
];

/**
 * Links de redes sociais do footer.
 *
 * Componente atomico que exibe icones de redes sociais com links externos.
 *
 * @example
 * ```tsx
 * <FooterSocialLinks />
