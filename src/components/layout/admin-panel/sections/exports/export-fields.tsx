...
export function ExportSubmitButton({
  ...
  return (
    <button
      className={[
        "inline-flex min-h-11 items-center justify-center rounded-none border-2 border-[#1a1a1a] bg-[#1a1a1a] px-6 text-[11px] font-black uppercase tracking-[0.16em] text-brand-yellow transition-colors hover:bg-[#000] disabled:cursor-not-allowed disabled:border-[#1a1a1a]/35 disabled:bg-[#1a1a1a]/35 disabled:text-[#fbf7ef]",
        FOCUS_RING,
      ].join(" ")}
      disabled={disabled}
      type="submit"
