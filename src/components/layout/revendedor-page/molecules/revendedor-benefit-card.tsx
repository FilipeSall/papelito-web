...
export function RevendedorBenefitCard({
  ...
  return (
    <article className="relative overflow-hidden rounded-2xl bg-bg-light p-7">
      <div className="absolute right-0 top-0 h-24 w-24 rounded-bl-[64px] bg-brand-yellow/5" />

      <div className="relative flex h-full flex-col">
        <div className="flex size-[52px] items-center justify-center rounded-[14px] bg-brand-yellow">
          <Image alt="" height={22} src={benefit.iconSrc} width={22} />
        </div>

        <h3 className="mt-5 text-base font-black leading-[22px] tracking-[-0.3125px] text-brand-dark">
          {benefit.title}
        </h3>

        <p className="mt-2 text-sm leading-[22.75px] tracking-[-0.1504px] text-text-tertiary">
          {benefit.description}
        </p>
      </div>
    </article>
