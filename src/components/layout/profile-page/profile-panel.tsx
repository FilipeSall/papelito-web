...
export {
  hardDangerActionClass as profileDangerActionClass,
  hardPrimaryActionClass as profilePrimaryActionClass,
  hardQuietActionClass as profileQuietActionClass,
  hardSecondaryActionClass as profileSecondaryActionClass,
