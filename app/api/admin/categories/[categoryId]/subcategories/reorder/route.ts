...
import { reorderSubcategories, taxonomyErrorResponse } from "@/lib/server/admin-taxonomy";
...
export async function PUT(
  ...
  try {
    ...
    const response = taxonomyErrorResponse(error, "Não foi possível reordenar as subcategorias.");
