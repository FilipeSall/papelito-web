...
/**
 * Devolve uma caixa desativada à operação.
 *
 * A versão do perfil não muda: reativar não altera medida aprovada, só o estado. O WordPress
 * responde com a lista inteira, e é ela que a interface passa a exibir.
 *
...
export async function POST(_request: Request, { params }: RouteParams) {
  ...
  const result = await wpRest<unknown>(`/papelito/v1/vendor/me/packaging-profiles/${id}/reactivate`, {
